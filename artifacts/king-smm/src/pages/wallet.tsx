...
const topupSchema = z.object({
  amount: z.coerce.number().min(5, "Minimum topup is $5"),
...
export default function Wallet() {
  ...
  function onSubmit(values: z.infer<typeof topupSchema>) {
    topupMutation.mutate({ data: values }, {
      onSuccess: () => {
        toast({ title: "Top-up request submitted", description: "Your request is pending manual approval." });
        form.reset();
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card className="md:col-span-2 bg-card/50 border-white/5 backdrop-blur">
          <CardHeader>
            ...
            <CardDescription>Submit a manual payment transaction ID to request balance.</CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
                      ...
                      <FormItem>
                        ...
                        <Select onValueChange={field.onChange} value={field.value}>
                          ...
                          <SelectContent>
                            ...
                            <SelectItem value="upi">UPI / PayTM (India)</SelectItem>
                          </SelectContent>
                        </Select>
                        <FormMessage />
                      </FormItem>
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input placeholder="Enter TxID after sending payment" className="bg-background/50 border-white/10" {...field} />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                  )}
                />
                <Button type="submit" disabled={topupMutation.isPending} className="w-full bg-white text-black hover:bg-gray-200 border-0 mt-2">
